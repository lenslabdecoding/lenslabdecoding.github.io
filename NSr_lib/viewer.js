...
(function() {
  ...
  UserInterface = (function() {
    ...
    UserInterface.prototype.updateLayerList = function(layers, selectedIndex) {
      var decoding_icon, deletion_icon, download_icon, i, l, visibility_icon, _i, _ref;
      ...
      for (i = _i = 0, _ref = layers.length; 0 <= _ref ? _i < _ref : _i > _ref; i = 0 <= _ref ? ++_i : --_i) {
        ...
        decoding_icon = this.viewSettings.decodingIconEnabled ? "<div class='decoding_icon' title='Open Decoding List'><span class='glyphicon glyphicon-list'></i></div>" : '';
        $(this.layerListId).append($(("<li class='layer_list_item'>" + visibility_icon + "<div class='layer_label'>") + l.name + ("</div>" + decoding_icon + deletion_icon + download_icon + "</li>")));
      }
      ...
      $('.decoding_icon').click((function(_this) {
        return function(e) {
          return revealMessage1($('.decoding_icon').index($(e.target).closest('div')));
        };
      })(this));
